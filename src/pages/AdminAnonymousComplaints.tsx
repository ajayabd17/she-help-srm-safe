...
const AdminAnonymousComplaints = () => {
    ...
    const checkAdmin = () => {
      ...
      if (user && user.role === 'admin') {
        ...
        try {
          ...
          const anonymousComplaints = [...mockComplaints, ...storedComplaints].filter(c => c.anonymous);
          setComplaints(anonymousComplaints);
        } catch (error) {
          console.error("Error loading complaints:", error);
          setComplaints(mockComplaints.filter(c => c.anonymous));
        }
      } else {
        navigate('/login');
      }
...
export default AdminAnonymousComplaints;
